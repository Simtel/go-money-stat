...
// Source: internal/adapter/sqliterepo/zenrepo/transactions/repository.go
...
func (m *MockRepositoryInterface) GetAll() ([]model.Transaction, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryInterfaceMockRecorder) GetByYear(year interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByYear", reflect.TypeOf((*MockRepositoryInterface)(nil).GetByYear), year)
}
